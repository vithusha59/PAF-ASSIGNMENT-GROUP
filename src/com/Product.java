...
public class Product {
	...
	public String readProducts() {
		...
		try {
			...
			output = "<table border='1'><tr><th>Product_Code</th><th>Product_Name</th><th>Category</th><th>collaborators</th><th>Price</th><th>Email</th><th>Update</th><th>Remove</th></tr>";
			...
			while (rs.next()) {
				...
				// Add into the html table
				  output += "<tr><td><input id='hidProductIDUpdate' name='hidProductIDUpdate' type='hidden' value='" + Product_ID + "'>" + Product_Code + "</td>";
				//output += "<tr><td><input id=\"hidProductIDUpdate\" name=\"hidProductIDUpdate\"type=\"hidden\" value=\"" + Product_ID + "\">"+ Product_Code + "</td>"; 
				...
				// buttons
				//output += "<td><input name=\"btnUpdate\" type=\"button\" value=\"Update\" class=\" btnUpdate btn btn-secondary\"></td><td><form method=\"post\" action=\"Product.jsp\"><input name=\"btnRemove\" type=\"submit\"value=\"Remove\" class=\"btn btn-danger\"><input name=\"hidProductIDDelete\" type=\"hidden\"value=\"" + Product_ID + "\">" + "</form></td></tr>";
				output += "<td><input name='btnUpdate' type='button'value='Update'class='btnUpdate btn btn-secondary'></td><td><input name='btnRemove' type='button'value='Remove'class='btnRemove btn btn-danger' data-productid='"+ Product_ID + "'>" + "</td></tr>";
			}
	...
	// Insert
	public String insertProducts(String Product_Code, String Product_Name, String Category, String collaborators,
			String Price, String Email) {
